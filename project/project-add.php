 ...
 <div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="7%" bgcolor="#f7fcff">Jabatan<br>Project</th>
											  <th width="10%" bgcolor="#f7fcff">Pegawai</th>
											  <th width="8%" bgcolor="#f7fcff">Department</th>
											  <th width="8%" bgcolor="#f7fcff">Divisi</th>
											  <th width="17%" bgcolor="#f7fcff">Jabatan</th>
											  <th width="9%" bgcolor="#f7fcff">Upload Sertifikat<br>(Jika Ada)</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center" nowrap><div class="form-group">
																						<select class="form-control kt-selectpicker" data-live-search="true">
																							<option value="AK" selected>Project Manager</option>
																							<option value="HI">SPV Electrical Engineering</option>
																							<option value="HI">SPV Network Engineering</option>
																						</select>
																					</div></td>
					                         ...
					                         <select data-live-search="true" class="form-control kt-selectpicker" id="tipe">
												...
												<td style="text-align:center" nowrap><input type="text" class="form-control form-control-sm" placeholder="" disabled></td>
												<td style="text-align:left" nowrap><input type="text" class="form-control form-control-sm" placeholder="" disabled></td>
												<td style="text-align:center" nowrap><input type="text" class="form-control form-control-sm" placeholder="" disabled></td>
												...
												<td style="text-align:center" nowrap><button type="button" class="btn btn-outline-success btn-elevate btn-icon btn-icon btn-sm" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Tambah Data" data-html="true"><i class="fa fa-plus-circle"></i></button> <button type="button" class="btn btn-outline-hover-danger btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Hapus Data" data-html="true"><i class="fa fa-trash-alt"></i></button></td>
										  </tr>
										  <tr>
