...
<td align="left" valign="left" style="text-align:left">Bontoala</td>
												<td align="left" valign="left" style="text-align:left">Baraya</td>
...
<td align="left" valign="left" style="text-align:left">Bontoala</td>
										  ...
										  <tr>
												<td>15</td>
<td align="left" valign="left" style="text-align:left">Bontoala</td>
												<td align="left" valign="left" style="text-align:left">Bontoala Parang</td>
...
<div class="col-lg-6">
														<label>Nama Wilayah :</label>
														 <input type="text" class="form-control form-control-sm"  placeholder="Masukkan Nama Kelurahan">
