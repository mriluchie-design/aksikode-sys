					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="40%" bgcolor="#f7fcff">Nama Jabatan</th>
										...
										<tbody>
											...
											<tr>
												<td>2</td>
												<td align="left" valign="left" style="text-align:left">Pimpinan</td>
										  ...
										  <tr>
												<td>3</td>
												<td align="left" valign="left" style="text-align:left">Direksi</td>
										  ...
										  <tr>
												<td>4</td>
												<td align="left" valign="left" style="text-align:left">Lainnya</td>
