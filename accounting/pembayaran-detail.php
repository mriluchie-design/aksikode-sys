					...
					<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
						...
						<div class="kt-portlet__body">
							<div class="kt-portlet__content">
								...
								<div class="col-lg-3">
										<label>Penerima : <code>*</code></label>
										<input type="text" class="form-control form-control-sm" placeholder="Vendor" disabled>
									</div>
									
									<div class="col-lg-6">
										<label class="">&nbsp;</label>
											<input type="text" class="form-control form-control-sm" placeholder="PT. Aksi Kode Indonesia" disabled>
									</div>
