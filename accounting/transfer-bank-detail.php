...
<div class="btn-group" role="group">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item">
								<a href="#" class="kt-nav__link" data-toggle="modal" data-target="#void_penerimaan">
									<i class="kt-nav__link-icon fa fa-undo-alt"></i>
									<span class="kt-nav__link-text">Void Transaksi</span>
								</a>
							</li>
<li class="kt-nav__item">
			...
			<div class="row">
				<div class="col-xl-8">
					...
					<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
						<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Rincian Transfer</div><br><br>
						<div class="kt-portlet__body">
							<div class="kt-portlet__content">
								...
								<div class="col-lg-4">
										...
										<input type="text" class="form-control form-control-sm" placeholder="Kas Kecil" disabled>
									</div>
					...
					<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
						...
						<div class="kt-portlet__body">
							<div class="kt-portlet__content">
								<div class="form-group row">
								<div class="col-lg-6">
										<label>Saldo Kas/Bank Asal : </label>
										<div class="input-group input-group-sm">
																						  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
									...
									<div class="col-lg-6">
										<label>Saldo Kas/Bank Tujuan : </label>
										<div class="input-group input-group-sm">
																						  <div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
																						  <input style="text-align:right" type="text" class="form-control form-control-sm" placeholder="2.000.000.000" aria-describedby="basic-addon1" disabled>
																						  <div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
