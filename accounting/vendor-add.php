...
<div class="m-portlet m-portlet--tabs">
											...
											<ul class="nav nav-pills nav-fill" role="tablist">
												...
												<li class="nav-item m-tabs__item">
													<a class="nav-link m-tabs__link" data-toggle="tab" href="#m_tabs_6_2" role="tab">
														<i class="fa fa-wallet"></i>Rekening
													</a>
												</li>
												<li class="nav-item m-tabs__item">
												...
												<li class="nav-item m-tabs__item">
													<a class="nav-link m-tabs__link" data-toggle="tab" href="#m_tabs_6_4" role="tab">
														<i class="fa fa-money-bill"></i>Saldo Hutang
													</a>
												</li>
                      ...
                      <div class="row">
						...
						<div class="col-lg-4">
                          <label><span style="color:#ff0000">*</span> Tipe Vendor :</label>
...
<div class="form-group row">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="" >
								...
								<div class="col-xl-6">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Alamat Pembayaran</div><br><br>
										 <div class="kt-portlet__body">
											<div class="kt-portlet__content">
...
<div class="col-xl-6">
 ...
 <div class="col-xl-10">
 <a href="#" style="margin-top:10px;" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_tambah_rekening">
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" bgcolor="#f7fcff">Nomor Rekening</th>
											  <th width="5%" bgcolor="#f7fcff">Atas Nama</th>
											  <th width="15%" bgcolor="#f7fcff">Bank</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left" nowrap>0255804010</td>
												<td style="text-align:left" nowrap>Muhammad Nasrullah</td>
												<td style="text-align:left" nowrap>Bank Central Asia</td>
						...
						<div class="col-lg-6">
                          <label><span style="color:#ff0000">*</span> Akun Utang :</label>
                          <select class="form-control kt-selectpicker" data-live-search="true">
                      ...
                      <div class="col-lg-2">
						...
						<div class="col-lg-6">
                                ...
                                <select class="form-control kt-selectpicker" data-live-search="true">
                                      ...
                                      <option value="1">Tidak Dikreditkan</option>
