...
<div class="btn-group" role="group">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item">
								<a href="#" class="kt-nav__link" data-toggle="modal" data-target="#modal_pencatatan_beban">
									<i class="kt-nav__link-icon fa fa-file-signature"></i>
									<span class="kt-nav__link-text">Pencatatan Beban</span>
								</a>
							</li>
							<li class="kt-nav__item">
								<a href="#" class="kt-nav__link" data-toggle="modal" data-target="#modal_po">
									<i class="kt-nav__link-icon fa fa-file-invoice"></i>
									<span class="kt-nav__link-text">Purchase Order</span>
								</a>
							</li>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
						...
						<div class="kt-portlet__body">
							<div class="kt-portlet__content">
								<div class="form-group row">
									...
									<div class="col-lg-3">
										...
										<div class="input-group">
											...
											<input id="1" type="text" class="form-control" placeholder="110102.062026.02.0001" disabled>
								...
								<div class="form-group row">
									...
									<div class="col-lg-3">
										<label class="">&nbsp;</label>
											<input id="1" type="text" class="form-control" placeholder="PT. Aksi Kode Indonesia" disabled>
									</div>
 ...
 <a href="#" class="btn btn-brand" data-toggle="modal" data-target="#modal_tambah_akun_pembayaran">
																				...
																				<thead>
																					<tr>
																					  ...
																					  <th width="15%" bgcolor="#f7fcff">Nama Akun</th>
																						...
																						<th width="10%" bgcolor="#f7fcff">Bukti Pembayaran</th>
								...
								<div class="modal-dialog modal-dialog-centered modal-md" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												<span class="kt-portlet__head-icon"><i class="kt-font-brand fa fa-clipboard-list"></i></span>
												<h3 class="kt-portlet__head-title kt-font-danger kt-bold">TAMBAH PEMBAYARAN</h3>
											</div>
<div class="kt-portlet__head-toolbar">
...
<div class="form-group row">
<div class="col-lg-8">
														<label class="kt-font-brand">Akun Pembayaran :</label>
